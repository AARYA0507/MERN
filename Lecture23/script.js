...
let firstUserAbove30 = users.find((user) => user.age > 30);
console.log(firstUserAbove30.name);
...
function sumOfAgesBelow30(users) {
  return users
...
function getNamesOfActiveUsers(users) {
  return users
...
try {
  ...
  let studentName = "Aarya";
  console.log(studentName);
  if (studentName === " Aarya") throw new Error("Aarya found!!");
} catch (error) {
