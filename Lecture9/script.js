...
const students = ["Rahul", "Raj", "sham"];
addStudent(students, "babu", "Prateek", "rohit");
...
const arr1 = [1, 3, 5, 6];
console.log({arr1});
console.log("spreaded array: ", [0, ...arr1, 96, 87, 68]);
